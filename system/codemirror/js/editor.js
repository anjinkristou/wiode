  ...
  Editor.prototype = {
    ...
    keyDown: function(event) {
      ...
      // Only in Firefox is the default behavior for PgUp/PgDn correct.
        ...
        else if (code == 85 && this.options.uploadFunction) { // U
          this.options.uploadFunction();
          event.stop();
        }
        else if (code == 79 && this.options.viewFunction) { // O
          this.options.viewFunction();
          event.stop();
        }
        else if (code == 71 && this.options.gotoFunction) { // G
          this.options.gotoFunction();
          event.stop();
        }
        else if (code == 70 && this.options.findFunction) { // F
          this.options.findFunction();
          event.stop();
        }
        else if (code == 82 && this.options.replaceFunction) { // R
          this.options.replaceFunction();
          event.stop();
        }
        else if (code == 80 && this.options.printFunction) { // P
          this.options.printFunction();
          event.stop();
        }
        else if (code == 72 && this.options.helpFunction) { // P
          this.options.helpFunction();
          event.stop();
        }
        else if (code == 73 && this.options.snippetsFunction) { // P
          this.options.snippetsFunction();
          event.stop();
        }
        else if (code == 84 && this.options.colorpickerFunction) { // P
          this.options.colorpickerFunction();
          event.stop();
        }
